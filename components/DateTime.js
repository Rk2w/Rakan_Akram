        ...
        <View style={styles.container}>
            <View>
                ...
                <View style={styles.weatherItemContainer}>
                    ...
                    <WeatherItem title="Sunrise" value={current ? moment.tz(current.sunrise * 1000, timezone).format('HH:mm') : ""} unit="" />
                    <WeatherItem title="Sunset" value={current ? moment.tz(current.sunset * 1000, timezone).format('HH:mm') : ""} unit="" />
                </View>
            </View>
